...
function main(){
    ...
    var ets = {
        et_interval : new EditTextWithLabel(win, "interval (mm):", DEFAULT_WIDTH),
...
function dupAlongThePath(foreground_obj, paths, ets){
    try{
        for(var i = 0; i < paths.length; i++){
			var etsIntervalToPnts=ets.et_interval.getValue() / (1/ (72/25.4))
            var pnts = brokenPath( paths[i], etsIntervalToPnts );
